...
SM.ShamanCampaignData = {
    ...
    npcLocations = {
        ...
        ["Firelord Smolderon"]          = { mapID = 736, x = 0.3000, y = 0.5300 },
    ...
    chapters = {
        {
            ...
            quests = {
                ...
                { id = 42198, name = "Champion: Stormcaller Mylra",  npc = "Farseer Nobundo" },
                { id = 42197, name = "Champion: Duke Hydraxis",      npc = "Farseer Nobundo" },
...

        {
            ...
            quests = {
                ...
                { id = 41773, name = "The Firelord's Command",       npc = "Advisor Sevel" },
                { id = 41934, name = "The Brand of Damnation",       npc = "Firelord Smolderon" },
