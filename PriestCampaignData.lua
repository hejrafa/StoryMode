...
SM.PriestCampaignData = {
    ...
    npcLocations = {
        ...
        ["Mariella Ward"]               = { mapID = 702, x = 0.5200, y = 0.5100 },
        ["Aelthalyste"]                 = { mapID = 646, x = 0.4500, y = 0.6300 },
        ["Aponi Brightmane"]            = { mapID = 702, x = 0.5000, y = 0.4800 },
    },
    ...
    chapters = {
...

        {
            ...
            quests = {
                ...
                { id = 43387, name = "Scarlet Redemption",          npc = "Mariella Ward" },
                { id = 43388, name = "Apostate Liberation",         npc = "Mariella Ward" },
...

        {
            ...
            quests = {
                ...
                { id = 43391, name = "Secrets of the Void",          npc = "Alonsus Faol" },
                { id = 43392, name = "Into the Void",                npc = "Alonsus Faol" },
...

        {
            ...
            quests = {
                { id = 43394, name = "Crossing Legion Lines",       npc = "Alonsus Faol" },
                ...
                { id = 43420, name = "A Hero's Weapon",              npc = "Moira Thaurissan" },
            },
        },
