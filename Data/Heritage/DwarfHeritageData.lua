    ...
    chapters = {
        {
            ...
            quests = {
                ...
                { id = 53835, name = "Something Valuable, Perhaps?", npc = "Ancient Tablet", mapID = 84, x = 0.5220, y = 0.1350, location = "Heritage of the Bronzebeard, Ironforge / Dun Morogh / Loch Modan" },
                ...
                { id = 53841, name = "Shards of the Past", npc = "Armor Stand", mapID = 87, x = 0.3950, y = 0.5490, location = "Heritage of the Bronzebeard, Ironforge / Dun Morogh / Loch Modan" },
                ...
                { id = 53845, name = "Forging the Armor", npc = "Grumnus Steelshaper", mapID = 87, x = 0.3980, y = 0.5560, location = "Heritage of the Bronzebeard, Ironforge / Dun Morogh / Loch Modan" },
