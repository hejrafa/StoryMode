    ...
    chapters = {
        {
            ...
            quests = {
                { id = 78068, name = "An Artificer's Appeal", npc = "Automatic / Magically-Sealed Parcel", mapID = 103, x = 0.5450, y = 0.5030, location = "Heritage of the Draenei, Exodar / Outland / Bloodmyst Isle" },
                ...
                { id = 78072, name = "An Old Wound", npc = "Apprentice Beruun", mapID = 103, x = 0.5480, y = 0.4980, location = "Heritage of the Draenei, Exodar / Outland / Bloodmyst Isle" },
                ...
                { id = 78076, name = "Emergency Efforts", npc = "Chieftain Hatuun", mapID = 103, x = 0.5480, y = 0.4980, location = "Heritage of the Draenei, Exodar / Outland / Bloodmyst Isle" },
                { id = 78078, name = "Assessing the Enemy", npc = "Arzaal", mapID = 103, x = 0.5480, y = 0.4980, location = "Heritage of the Draenei, Exodar / Outland / Bloodmyst Isle" },
                { id = 78077, name = "Beneath the Skin", npc = "Chieftain Hatuun", mapID = 103, x = 0.5480, y = 0.4980, location = "Heritage of the Draenei, Exodar / Outland / Bloodmyst Isle" },
                { id = 78079, name = "Excision", npc = "Prophet Velen" },
                { id = 78080, name = "At the Source", npc = "Arzaal", mapID = 103, x = 0.5480, y = 0.4980, location = "Heritage of the Draenei, Exodar / Outland / Bloodmyst Isle" },
                { id = 78081, name = "Pain Recedes", npc = "Prophet Velen" },
                { id = 78082, name = "A Burden Shared", npc = "Prophet Velen" },
                { id = 78083, name = "Our Path Forward", npc = "Grand Anchorite Almonen", mapID = 103, x = 0.3220, y = 0.5430, location = "Heritage of the Draenei, Exodar / Outland / Bloodmyst Isle" },
            },
        },
    },
}
