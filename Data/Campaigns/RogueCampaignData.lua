...
SM.RogueCampaignData = {
    ...
    npcLocations = {
        ...
        ["Lord Jorach Ravenholdt"]      = { mapID = 626, x = 0.5060, y = 0.7540, location = "Dalaran / Broken Isles" },
        ["Garona Halforcen"]            = { mapID = 626, x = 0.5060, y = 0.7540, location = "Dalaran / Broken Isles" },
        ["Valeera Sanguinar"]           = { mapID = 626, x = 0.5060, y = 0.7540, location = "Dalaran / Broken Isles" },
        ["Fleet Admiral Tethys"]        = { mapID = 626, x = 0.5060, y = 0.7540, location = "Dalaran / Broken Isles" },
        ["Marin Noggenfogger"]          = { mapID = 626, x = 0.5060, y = 0.7540, location = "Dalaran / Broken Isles" },
        ["Nikki the Gossip"]            = { mapID = 626, x = 0.5060, y = 0.7540, location = "Dalaran / Broken Isles" },
        ...
        ["Princess Tess Greymane"]      = { mapID = 626, x = 0.5060, y = 0.7540, location = "Dalaran / Broken Isles" },
