...
SM.RogueCampaignData = {
    ...
    npcLocations = {
        ...
        ["Marin Noggenfogger"]          = { mapID = 626, x = 0.5060, y = 0.7540, location = "Dalaran / Broken Isles" },
        ["Nikki the Gossip"]            = { mapID = 626, x = 0.3740, y = 0.4420, location = "Dalaran / Broken Isles" },
        ["Vanessa VanCleef"]            = { mapID = 626, x = 0.5060, y = 0.7540, location = "Dalaran / Broken Isles" },
