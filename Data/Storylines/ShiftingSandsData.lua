    ...
    chapters = {
        ...
        },
        {
            ...
            quests = {
                ...
                { id = 8734, name = "Tyrande and Remulos", npc = "Forest Wisp", mapID = 220, x = 0.6000, y = 0.5000, location = "Green Scepter Shard, Silithus / Tanaris / Moonglade / Azshara / Blackwing Lair" },
        ...
        },
        {
            ...
            quests = {
                ...
                { id = 8578, name = "Scrying Goggles? No Problem!", npc = "Stewvul", mapID = 71, x = 0.6500, y = 0.1800, location = "Blue Scepter Shard, Silithus / Tanaris / Moonglade / Azshara / Blackwing Lair" },
                ...
                { id = 8599, name = "Love Song for Narain", npc = "Meridith the Mermaiden", optional = true, mapID = 71, x = 0.6500, y = 0.1800, location = "Blue Scepter Shard, Silithus / Tanaris / Moonglade / Azshara / Blackwing Lair" },
                { id = 8598, name = "rAnS0m", npc = "Freshly Dug Dirt", mapID = 71, x = 0.6500, y = 0.1800, location = "Blue Scepter Shard, Silithus / Tanaris / Moonglade / Azshara / Blackwing Lair" },
        ...
        },
        {
            ...
            quests = {
                ...
                { id = 8743, name = "Bang a Gong!", npc = "Scarab Gong", mapID = 71, x = 0.6400, y = 0.5000, location = "Bang a Gong, Silithus / Tanaris / Moonglade / Azshara / Blackwing Lair" },
                { id = 8744, name = "Treasure of the Timeless One", npc = "Jonathan the Revelator", mapID = 71, x = 0.6400, y = 0.5000, location = "Bang a Gong, Silithus / Tanaris / Moonglade / Azshara / Blackwing Lair" },
            },
        },
    },
}
