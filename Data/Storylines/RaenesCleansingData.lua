...
SM.RaenesCleansingData = {
    ...
    startQuest = { id = 991, name = "Raene's Cleansing", npc = "Raene Wolfrunner", location = "Astranaar, Ashenvale" },
    startMapID = 63,
    startX = 0.3620,
    startY = 0.4980,
    ...
    npcLocations = {
        ...
        ["Shael'dryn"] = { mapID = 63, x = 0.5300, y = 0.4600, location = "the moonwell east of Iris Lake, Ashenvale" },
    ...
    chapterDisplayIDs = {
        ["Teronis' Journal"] = 2177,
        ["Dartol's Rod"] = 2215,
        ["The Uncorrupted Furbolg"] = 3687,
    },
