...
SM.SylvanasData = {
    ...
    npcLocations = {
        ...
        ["Grand Executor Mortuus"]   = { mapID = 18,   x = 0.4200, y = 0.7300 , location = "Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas"},  -- (verify)
        ...
        ["Dark Ranger Alina"]        = { mapID = 862,  x = 0.5000, y = 0.6500, location = "Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
        ...
        ["Lilian Voss"]              = { mapID = 85,   x = 0.5050, y = 0.5700 , location = "Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas"},  -- (verify)
        ["Valeera Sanguinar"]        = { mapID = 85,   x = 0.5050, y = 0.5700, location = "Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
    ...
    chapters = {
        ...
        -- CHAPTER 5: The Broken Shore
        {
            ...
            quests = {
                { id = 43926, name = "Legion: The Legion Returns",  npc = "Holgar Stormaxe", mapID = 1, x = 0.5560, y = 0.1100, location = "The Broken Shore, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 40518, name = "The Battle for Broken Shore", npc = "Captain Russo" },
                { id = 40522, name = "Fate of the Horde",           npc = "Eitrigg", mapID = 1, x = 0.5560, y = 0.1100, location = "The Broken Shore, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 40760, name = "Emissary",                    npc = "Allari the Souleater", optional = true, mapID = 1, x = 0.5560, y = 0.1100, location = "The Broken Shore, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 40607, name = "Demons Among Us",             npc = "Allari the Souleater", optional = true, mapID = 1, x = 0.5560, y = 0.1100, location = "The Broken Shore, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 40605, name = "Keep Your Friends Close",     npc = "Elthyn Da'rai",        optional = true, mapID = 1, x = 0.5560, y = 0.1100, location = "The Broken Shore, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
            },
        },
        ...
        -- CHAPTER 8.5: The rescue of Baine Bloodhoof
        {
            ...
            quests = {
                ...
                { id = 55782, name = "Stay of Execution",    npc = "Thrall",             showIf = 55781, mapID = 862, x = 0.5000, y = 0.6500, location = "Stay of Execution, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
            },
        },
        ...
        -- CHAPTER 9: The Horde fractures
        {
            ...
            quests = {
                ...
                { id = 56495, name = "They Move Against Us",     npc = "Sylvanas Windrunner", showIf = 55780, mapID = 862, x = 0.5840, y = 0.6260, location = "Breaking the Cycle, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 56833, name = "Leaders of the Horde",  npc = "Sylvanas Windrunner", showIf = 55780, mapID = 862, x = 0.5840, y = 0.6260, location = "Breaking the Cycle, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
        ...
        -- CHAPTER 11: The veil tears open / descent into the Maw
        {
            ...
            quests = {
                { id = 60545, name = "Shadowlands: A Chilling Summons", npc = "Highlord Darion Mograine", faction = "Alliance", mapID = 85, x = 0.5050, y = 0.5700, location = "A Chilling Summons, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 61874, name = "Shadowlands: A Chilling Summons", npc = "Highlord Darion Mograine", faction = "Horde", mapID = 85, x = 0.5050, y = 0.5700, location = "A Chilling Summons, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 59751, name = "Through the Shattered Sky",       npc = "Highlord Bolvar Fordragon", mapID = 1670, x = 0.3990, y = 0.6860, location = "A Chilling Summons, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 59759, name = "The Lion's Cage",                  npc = "Lady Jaina Proudmoore", mapID = 1670, x = 0.3990, y = 0.6860, location = "A Chilling Summons, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 59760, name = "The Afflictor's Key",              npc = "Lady Jaina Proudmoore", mapID = 1670, x = 0.3990, y = 0.6860, location = "A Chilling Summons, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 59765, name = "Wounds Beyond Flesh",              npc = "Lady Jaina Proudmoore", mapID = 1670, x = 0.3990, y = 0.6860, location = "A Chilling Summons, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 59767, name = "The Path to Salvation",            npc = "Lady Jaina Proudmoore", mapID = 1670, x = 0.3990, y = 0.6860, location = "A Chilling Summons, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 59770, name = "Stand as One",                     npc = "Lady Jaina Proudmoore", mapID = 1670, x = 0.3990, y = 0.6860, location = "A Chilling Summons, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
            },
        },
        ...
        -- CHAPTER 13: The Jailer's first move
        {
            ...
            quests = {
                ...
                { id = 63856, name = "A Gathering of Covenants",  npc = "Highlord Bolvar Fordragon", mapID = 1670, x = 0.3990, y = 0.6860, location = "Chains of Domination, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 63857, name = "Voices of the Eternal",     npc = "Highlord Bolvar Fordragon", mapID = 1670, x = 0.3990, y = 0.6860, location = "Chains of Domination, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 63578, name = "The Battle of Ardenweald",  npc = "Highlord Bolvar Fordragon", mapID = 1670, x = 0.3990, y = 0.6860, location = "Chains of Domination, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 63638, name = "Can't Turn Our Backs",      npc = "Lady Moonberry", mapID = 1670, x = 0.3990, y = 0.6860, location = "Chains of Domination, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 63904, name = "The Heart of Ardenweald",   npc = "Lady Moonberry", mapID = 1670, x = 0.3990, y = 0.6860, location = "Chains of Domination, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 63639, name = "Report to Oribos",          npc = "Lady Moonberry", mapID = 1670, x = 0.3990, y = 0.6860, location = "Chains of Domination, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
            },
        },
        ...
        -- CHAPTER 15: The restoration of Sylvanas's soul
        {
            ...
            quests = {
                ...
                { id = 64830, name = "Enlisting the Enlightened",        npc = "Highlord Bolvar Fordragon", mapID = 1961, x = 0.6280, y = 0.2500, location = "Shattered Legacies, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64833, name = "Forging Unity from Diversity",     npc = "Elder Ara", mapID = 1970, x = 0.6470, y = 0.5350, location = "Shattered Legacies, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64831, name = "Remnants of the First Ones",       npc = "Elder Ara", mapID = 1970, x = 0.6470, y = 0.5350, location = "Shattered Legacies, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64832, name = "Reclaiming Provis Esper",          npc = "Elder Ara", mapID = 1970, x = 0.6470, y = 0.5350, location = "Shattered Legacies, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64837, name = "The Pilgrim's Journey",            npc = "Elder Ara", mapID = 1970, x = 0.6470, y = 0.5350, location = "Shattered Legacies, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64834, name = "Glow and Behold",                  npc = "Elder Ara", mapID = 1970, x = 0.6470, y = 0.5350, location = "Shattered Legacies, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64838, name = "Where There's a Pilgrim, There's a Way", npc = "Elder Ara", mapID = 1970, x = 0.6470, y = 0.5350, location = "Shattered Legacies, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64969, name = "In the Weeds",                     npc = "Elder Ara", mapID = 1970, x = 0.6470, y = 0.5350, location = "Shattered Legacies, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64835, name = "Pluck from the Vines",             npc = "Elder Ara", mapID = 1970, x = 0.6470, y = 0.5350, location = "Shattered Legacies, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64836, name = "Nip It in the Bud",                npc = "Elder Ara", mapID = 1970, x = 0.6470, y = 0.5350, location = "Shattered Legacies, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64839, name = "Root of the Problem",              npc = "Elder Ara", mapID = 1970, x = 0.6470, y = 0.5350, location = "Shattered Legacies, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64840, name = "Unchecked Growth",                 npc = "Elder Ara", mapID = 1970, x = 0.6470, y = 0.5350, location = "Shattered Legacies, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64841, name = "Take Charge",                      npc = "Elder Ara", mapID = 1970, x = 0.6470, y = 0.5350, location = "Shattered Legacies, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 65331, name = "Herbal Remedies",                  npc = "Elder Ara", mapID = 1970, x = 0.6470, y = 0.5350, location = "Shattered Legacies, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64842, name = "Flora Frenzy",                     npc = "Elder Ara", mapID = 1970, x = 0.6470, y = 0.5350, location = "Shattered Legacies, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64843, name = "Key Crafting",                     npc = "Elder Ara", mapID = 1970, x = 0.6470, y = 0.5350, location = "Shattered Legacies, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
        ...
        -- CHAPTER 17: The answer to Domination
        {
            ...
            quests = {
                { id = 64799, name = "The Broken Crown",             npc = "Highlord Bolvar Fordragon", mapID = 1970, x = 0.3500, y = 0.6475, location = "Crown of Wills, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64800, name = "Our Last Option",              npc = "Highlord Bolvar Fordragon", mapID = 1970, x = 0.3500, y = 0.6475, location = "Crown of Wills, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64802, name = "Hello, Darkness",              npc = "The Primus", mapID = 1970, x = 0.3500, y = 0.6475, location = "Crown of Wills, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64801, name = "Elder Eru",                    npc = "Elder Eru", mapID = 1970, x = 0.3500, y = 0.6475, location = "Crown of Wills, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64803, name = "Testing One Two",              npc = "Elder Eru", mapID = 1970, x = 0.3500, y = 0.6475, location = "Crown of Wills, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64804, name = "Cryptic Catalogue",            npc = "Elder Eru", mapID = 1970, x = 0.3500, y = 0.6475, location = "Crown of Wills, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64805, name = "The Not-Scientific Method",    npc = "Elder Eru", mapID = 1970, x = 0.3500, y = 0.6475, location = "Crown of Wills, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64853, name = "Two Paths to Tread",           npc = "Elder Eru", mapID = 1970, x = 0.3500, y = 0.6475, location = "Crown of Wills, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64809, name = "One Half of the Equation",     npc = "The Primus", mapID = 1970, x = 0.3500, y = 0.6475, location = "Crown of Wills, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64810, name = "Oppress and Destroy",          npc = "Highlord Bolvar Fordragon", mapID = 1970, x = 0.3500, y = 0.6475, location = "Crown of Wills, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64811, name = "Aggressive Excavation",        npc = "Highlord Bolvar Fordragon", mapID = 1970, x = 0.3500, y = 0.6475, location = "Crown of Wills, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64806, name = "Where the Memory Resides",     npc = "Highlord Bolvar Fordragon", mapID = 1970, x = 0.3500, y = 0.6475, location = "Crown of Wills, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64807, name = "What We Wish to Forget",       npc = "Highlord Bolvar Fordragon", mapID = 1970, x = 0.3500, y = 0.6475, location = "Crown of Wills, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64808, name = "What Makes Us Strong",         npc = "Sylvanas Windrunner", mapID = 862, x = 0.5840, y = 0.6260, location = "Crown of Wills, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64798, name = "What We Overcome",             npc = "Highlord Bolvar Fordragon", mapID = 1970, x = 0.3500, y = 0.6475, location = "Crown of Wills, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64812, name = "Forge of Domination",          npc = "The Primus", mapID = 1970, x = 0.3500, y = 0.6475, location = "Crown of Wills, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 64813, name = "The Crown of Wills",           npc = "The Primus", mapID = 1970, x = 0.3500, y = 0.6475, location = "Crown of Wills, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
        ...
        -- CHAPTER 19: The long walk
        {
            ...
            quests = {
                { id = 65249, name = "The Jailer's Defeat",  npc = "Bolvar Fordragon", mapID = 1670, x = 0.3980, y = 0.6850, location = "Ring of Fates, Oribos" },
                ...
                { id = 66170, name = "Silent Vigil",         npc = "Dori'thur (Oribos)", location = "Ring of Transference, Oribos", mapID = 1670, x = 0.5050, y = 0.5100 },
            },
        },
        ...
        -- CHAPTER 21: Arator in the Maw
        {
            ...
            quests = {
                ...
                { id = 84996, name = "Vereesa's Tale",                      npc = "Arator", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 84997, name = "What Might Come",                     npc = "Vereesa Windrunner", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 84998, name = "Bringer of the Void",                 npc = "Vereesa Windrunner", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 85001, name = "Blessings Be Upon You",               npc = "Arator", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 85002, name = "Off to Tazavesh",                     npc = "Arator", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 85011, name = "Where in K'aresh is Alleria Windrunner?", npc = "Arator", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 85804, name = "The Parent Trap",                     npc = "Arator", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 85151, name = "In Her Shadow",                       npc = "Arator", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 85155, name = "Do You Have a Spare?",                npc = "Arator", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 85184, name = "Repossession is Nine-Tenths of the Law", npc = "Arator", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 85185, name = "Those As Well",                       npc = "Arator", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 85186, name = "A Cage for Alleria",                  npc = "Alleria Windrunner", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 85196, name = "Tag, You're It",                      npc = "Alleria Windrunner", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 85212, name = "A Void Test of Wills",                npc = "Alleria Windrunner", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 85213, name = "Off to Tazavesh, Again",              npc = "Arator", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 85214, name = "Here Goes Something",                 npc = "Ve'nari", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 84935, name = "Excising the Incursion",              npc = "Arator", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 84936, name = "To Cleanse Shadow's Stain",           npc = "Arator", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 84937, name = "Distant Echoes",                      npc = "Arator", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 84938, name = "Chaos Control",                       npc = "Sylvanas Windrunner", mapID = 862, x = 0.5840, y = 0.6260, location = "The Warning, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 84939, name = "Mad Space",                           npc = "Arator", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 84942, name = "The Final Hazard",                    npc = "Arator", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 84944, name = "Preludes and Preparations",           npc = "Sylvanas Windrunner", mapID = 862, x = 0.5840, y = 0.6260, location = "The Warning, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 84943, name = "The Long Vigil",                      npc = "Sylvanas Windrunner", mapID = 862, x = 0.5840, y = 0.6260, location = "The Warning, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 84945, name = "Repent of the Highborne",             npc = "Sylvanas Windrunner", mapID = 862, x = 0.5840, y = 0.6260, location = "The Warning, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 84946, name = "Returning to Life",                   npc = "Arator", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 84947, name = "Determination",                       npc = "Sylvanas Windrunner", mapID = 862, x = 0.5840, y = 0.6260, location = "The Warning, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
                { id = 84949, name = "The Eleventh Hour",                   npc = "Arator", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning, Icecrown / Silverpine / Orgrimmar / Oribos / The Maw / Quel'Thalas" },
            },
        },
        ...
        -- CHAPTER 22: Windrunner family history
        {
            ...
            quests = {
                { id = 93850, name = "Windrunner Spire: Haunting Melodies", npc = "Lirath Windrunner", optional = true, mapID = 94, x = 0.4500, y = 0.6300, location = "Windrunner Spire, Eversong Woods" },
            },
        },
