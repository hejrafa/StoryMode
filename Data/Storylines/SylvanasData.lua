...
SM.SylvanasData = {
    ...
    chapters = {
        ...
        -- CHAPTER 5: The Broken Shore
        {
            ...
            quests = {
                { id = 43926, name = "Legion: The Legion Returns",  npc = "Holgar Stormaxe", mapID = 1, x = 0.5560, y = 0.1100, location = "the Broken Shore scenario" },
                { id = 40518, name = "The Battle for Broken Shore", npc = "Stone Guard Mukar" },
                { id = 40522, name = "Fate of the Horde",           npc = "Eitrigg", mapID = 1, x = 0.5560, y = 0.1100, location = "the Broken Shore scenario" },
                { id = 40760, name = "Emissary",                    npc = "Allari the Souleater", optional = true, mapID = 1, x = 0.5560, y = 0.1100, location = "the Broken Shore scenario" },
                { id = 40607, name = "Demons Among Us",             npc = "Allari the Souleater", optional = true, mapID = 1, x = 0.5560, y = 0.1100, location = "the Broken Shore scenario" },
                { id = 40605, name = "Keep Your Friends Close",     npc = "Lady Sylvanas Windrunner",        optional = true, mapID = 1, x = 0.5560, y = 0.1100, location = "the Broken Shore scenario" },
            },
        },
        ...
        -- CHAPTER 8.5: The rescue of Baine Bloodhoof
        {
            ...
            quests = {
                ...
                { id = 55782, name = "Stay of Execution",    npc = "Thrall",             showIf = 55781, mapID = 862, x = 0.5000, y = 0.6500, location = "Orgrimmar" },
            },
        },
        ...
        -- CHAPTER 9: The Horde fractures
        {
            ...
            quests = {
                ...
                { id = 56495, name = "They Move Against Us",     npc = "Sylvanas Windrunner", showIf = 55780, mapID = 862, x = 0.5840, y = 0.6260, location = "Grommash Hold, Orgrimmar" },
                { id = 56833, name = "Leaders of the Horde",  npc = "Sylvanas Windrunner", showIf = 55780, mapID = 862, x = 0.5840, y = 0.6260, location = "Grommash Hold, Orgrimmar" },
        ...
        -- CHAPTER 11: The veil tears open / descent into the Maw
        {
            ...
            quests = {
                { id = 60545, name = "Shadowlands: A Chilling Summons", npc = "Highlord Darion Mograine", faction = "Alliance", mapID = 85, x = 0.5050, y = 0.5700, location = "Ring of Fates, Oribos" },
                { id = 61874, name = "Shadowlands: A Chilling Summons", npc = "Highlord Darion Mograine", faction = "Horde", mapID = 85, x = 0.5050, y = 0.5700, location = "Ring of Fates, Oribos" },
        ...
        -- CHAPTER 13: The Jailer's first move
        {
            ...
            quests = {
                ...
                { id = 63856, name = "A Gathering of Covenants",  npc = "Highlord Bolvar Fordragon", mapID = 1670, x = 0.3990, y = 0.6860, location = "Ring of Fates, Oribos" },
                ...
                { id = 63578, name = "The Battle of Ardenweald",  npc = "Highlord Bolvar Fordragon", mapID = 1670, x = 0.3990, y = 0.6860, location = "Ring of Fates, Oribos" },
                { id = 63638, name = "Can't Turn Our Backs",      npc = "Lady Moonberry", mapID = 1670, x = 0.3990, y = 0.6860, location = "Ring of Fates, Oribos" },
                { id = 63904, name = "The Heart of Ardenweald",   npc = "Lady Moonberry", mapID = 1670, x = 0.3990, y = 0.6860, location = "Ring of Fates, Oribos" },
                { id = 63639, name = "Report to Oribos",          npc = "Lady Moonberry", mapID = 1670, x = 0.3990, y = 0.6860, location = "Ring of Fates, Oribos" },
            },
        },
        ...
        -- CHAPTER 15: The restoration of Sylvanas's soul
        {
            ...
            quests = {
                ...
                { id = 64835, name = "Pluck from the Vines",             npc = "Elder Ara", mapID = 1970, x = 0.6470, y = 0.5350, location = "Shattered Legacies" },
                { id = 64836, name = "Nip It in the Bud",                npc = "Elder Ara", mapID = 1970, x = 0.6470, y = 0.5350, location = "Shattered Legacies" },
                { id = 64839, name = "Root of the Problem",              npc = "Elder Ara", mapID = 1970, x = 0.6470, y = 0.5350, location = "Shattered Legacies" },
                { id = 64840, name = "Unchecked Growth",                 npc = "Elder Ara", mapID = 1970, x = 0.6470, y = 0.5350, location = "Shattered Legacies" },
                { id = 64841, name = "Take Charge",                      npc = "Elder Ara", mapID = 1970, x = 0.6470, y = 0.5350, location = "Shattered Legacies" },
                { id = 65331, name = "Herbal Remedies",                  npc = "Elder Ara", mapID = 1970, x = 0.6470, y = 0.5350, location = "Shattered Legacies" },
                { id = 64842, name = "Flora Frenzy",                     npc = "Elder Ara", mapID = 1970, x = 0.6470, y = 0.5350, location = "Shattered Legacies" },
                { id = 64843, name = "Key Crafting",                     npc = "Elder Ara", mapID = 1970, x = 0.6470, y = 0.5350, location = "Shattered Legacies" },
        ...
        -- CHAPTER 17: The answer to Domination
        {
            ...
            quests = {
                ...
                { id = 64801, name = "Elder Eru",                    npc = "Elder Eru", mapID = 1970, x = 0.3500, y = 0.6475, location = "Haven, Zereth Mortis" },
                { id = 64803, name = "Testing One Two",              npc = "Elder Eru", mapID = 1970, x = 0.3500, y = 0.6475, location = "Haven, Zereth Mortis" },
                ...
                { id = 64809, name = "One Half of the Equation",     npc = "The Primus", mapID = 1970, x = 0.3500, y = 0.6475, location = "Haven, Zereth Mortis" },
                ...
                { id = 64811, name = "Aggressive Excavation",        npc = "Highlord Bolvar Fordragon", mapID = 1970, x = 0.3500, y = 0.6475, location = "Haven, Zereth Mortis" },
                ...
                { id = 64808, name = "What Makes Us Strong",         npc = "Sylvanas Windrunner", mapID = 862, x = 0.5840, y = 0.6260, location = "Haven, Zereth Mortis" },
                { id = 64798, name = "What We Overcome",             npc = "Highlord Bolvar Fordragon", mapID = 1970, x = 0.3500, y = 0.6475, location = "Haven, Zereth Mortis" },
                { id = 64812, name = "Forge of Domination",          npc = "The Primus", mapID = 1970, x = 0.3500, y = 0.6475, location = "Haven, Zereth Mortis" },
        ...
        -- CHAPTER 21: Arator in the Maw
        {
            ...
            quests = {
                ...
                { id = 85804, name = "The Parent Trap",                     npc = "Arator", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning" },
                { id = 85151, name = "In Her Shadow",                       npc = "Arator", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning" },
                { id = 85155, name = "Do You Have a Spare?",                npc = "Arator", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning" },
                { id = 85184, name = "Repossession is Nine-Tenths of the Law", npc = "Arator", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning" },
                { id = 85185, name = "Those As Well",                       npc = "Arator", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning" },
                { id = 85186, name = "A Cage for Alleria",                  npc = "Alleria Windrunner", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning" },
                ...
                { id = 84938, name = "Chaos Control",                       npc = "Sylvanas Windrunner", mapID = 862, x = 0.5840, y = 0.6260, location = "The Warning" },
                ...
                { id = 84944, name = "Preludes and Preparations",           npc = "Sylvanas Windrunner", mapID = 862, x = 0.5840, y = 0.6260, location = "The Warning" },
                { id = 84943, name = "The Long Vigil",                      npc = "Sylvanas Windrunner", mapID = 862, x = 0.5840, y = 0.6260, location = "The Warning" },
                { id = 84945, name = "Repent of the Highborne",             npc = "Sylvanas Windrunner", mapID = 862, x = 0.5840, y = 0.6260, location = "The Warning" },
                { id = 84946, name = "Returning to Life",                   npc = "Arator", mapID = 2339, x = 0.5100, y = 0.4500, location = "The Warning" },
                { id = 84947, name = "Determination",                       npc = "Sylvanas Windrunner", mapID = 862, x = 0.5840, y = 0.6260, location = "The Warning" },
