...
SM.LilianVossData = {
    ...
    npcLocations = {
        ...
        ["Executor Zygand"]           = { mapID = 18,  x = 0.6040, y = 0.5180 },
        ["High Executor Derrington"]  = { mapID = 18,  x = 0.8320, y = 0.6900 },
        ["Lieutenant Sanders"]        = { mapID = 18,  x = 0.8740, y = 0.4320 },
        -- Dungeons (interior — coordinates not meaningful)
        ["Hooded Crusader"]           = { mapID = 18,  x = 0.8540, y = 0.3100 },
        ["Talking Skull"]             = { mapID = 18,  x = 0.4800, y = 0.8560 },
    ...
    chapters = {
        ...
        -- CHAPTER 12: Testing Loyalties
        {
            ...
            quests = {
                ...
                { id = 55047, name = "Securing Warfang Hold",            npc = "Dark Ranger Alina", mapID = 862, x = 0.5840, y = 0.6260, location = "Warfang Hold, Tiragarde Sound" },
                { id = 55052, name = "Securing Warfang Hold",            npc = "Boss Mida", mapID = 862, x = 0.5840, y = 0.6260, location = "Warfang Hold, Tiragarde Sound" },
                { id = 55048, name = "Spy Games",                        npc = "Boss Mida", mapID = 862, x = 0.5840, y = 0.6260, location = "Warfang Hold, Tiragarde Sound" },
                { id = 55049, name = "Communication Breakdown",          npc = "Boss Mida", mapID = 862, x = 0.5840, y = 0.6260, location = "Warfang Hold, Tiragarde Sound" },
                { id = 55050, name = "Tickets, Please?",                 npc = "Boss Mida", mapID = 862, x = 0.5840, y = 0.6260, location = "Warfang Hold, Tiragarde Sound" },
        ...
        -- CHAPTER 13: What Comes After
        {
            ...
            quests = {
                { id = 57198, name = "Sense of Obligation",      npc = "High Overlord Saurfang", mapID = 862, x = 0.5840, y = 0.6260, location = "Orgrimmar" },
                { id = 57376, name = "The Hidden Need",          npc = "Lilian Voss" },
                { id = 58672, name = "A Gathering of Champions", npc = "Valeera Sanguinar", mapID = 862, x = 0.5840, y = 0.6260, location = "Orgrimmar" },
