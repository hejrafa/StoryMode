    ...
    chapters = {
        ...
        },
        {
            ...
            quests = {
                ...
                { id = 8470, name = "Deadwood Ritual Totem", npc = "Deadwood Ritual Totem", optional = true, mapID = 83, x = 0.2700, y = 0.3400, location = "Ritual Totems" },
                { id = 8471, name = "Winterfall Ritual Totem", npc = "Winterfall Ritual Totem", optional = true, mapID = 77, x = 0.5100, y = 0.8500, location = "Ritual Totems" },
