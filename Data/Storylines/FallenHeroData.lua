...
SM.FallenHeroData = {
    ...
    npcLocations = {
        ...
        ["Loramus Thalipedes"] = { mapID = 76, x = 0.3920, y = 0.3580, location = "the Bay of Storms, Azshara" },
        ["Lord Arkkoroc"] = { mapID = 76, x = 0.7700, y = 0.4200, location = "the Temple of Arkkoran, Azshara" },
        ["Galvan the Ancient"] = { mapID = 50, x = 0.6700, y = 0.3760, location = "northern Stranglethorn Vale" },
