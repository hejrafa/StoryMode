...
SM.DuskwoodData = {
    ...
    npcLocations = {
        ...
        ["Jitters"] = { mapID = 47, x = 0.1838, y = 0.5637, location = "western Duskwood" },
        ["Bishop Farthing"] = { mapID = 84, x = 0.3910, y = 0.2791, location = "Cathedral Square, Stormwind" },
        ["Glorin Steelbrow"] = { mapID = 56, x = 0.1058, y = 0.6059, location = "Menethil Harbor, Wetlands" },
        ["Waterlogged Chest"] = { mapID = 56, x = 0.1211, y = 0.6419, location = "Menethil Harbor, Wetlands" },
        ["Grimand Elmore"] = { mapID = 84, x = 0.5176, y = 0.1207, location = "the Dwarven District, Stormwind" },
        ...
        ["Watcher Ladimore"] = { mapID = 47, x = 0.7400, y = 0.4780, location = "Darkshire, Duskwood" },
        ["Weathered Grave"] = { mapID = 47, x = 0.1800, y = 0.2900, location = "the hill north of Raven Hill Cemetery" },
        ["A Weathered Grave"] = { mapID = 47, x = 0.1800, y = 0.2900, location = "the hill north of Raven Hill Cemetery" },
        ["Sven Yorgen"] = { mapID = 47, x = 0.0760, y = 0.3450, location = "Sven's camp, northwestern Duskwood" },
        ["Mound of loose dirt"] = { mapID = 47, x = 0.4985, y = 0.7771, location = "southern Duskwood" },
        ...
        ["Sealed Crate"] = { mapID = 84, x = 0.2945, y = 0.6153, location = "the Canals, Stormwind" },
        ...
        ["Old Footlocker"] = { mapID = 52, x = 0.4100, y = 0.6600, location = "Moonbrook, Westfall" },
    },

    npcDisplayIDs = {
        ["Commander Althea Ebonlocke"] = 4322,
        ["Lord Ello Ebonlocke"] = 4321,
        ["Madame Eva"] = 4323,
        ["Clerk Daltry"] = 1720,
        ["Sirra Von'Indi"] = 4324,
        ["Calor"] = 2027,
        ...
        ["Glorin Steelbrow"] = 3460,
        ["Grimand Elmore"] = 4998,
        ["Abercrombie"] = 4328,
        ["Stitches"] = 1693,
        ["Eliza"] = 10487,
        ["Mor'Ladim"] = 612,
        ["Watcher Ladimore"] = 2375,
        ["Sven Yorgen"] = 4327,
        ["Morbent Fel"] = 4272,
        ["Stalvan Mistmantle"] = 1562,
    },

    chapterDisplayIDs = {
        ["Darkshire Holds"] = 4322,
        ["Raven Hill"] = 4272,
        ["Morgan Ladimore"] = 612,
        ["The Legend of Stalvan"] = 1562,
        ["Worgen in the Woods"] = 2027,
        ["The Embalmer"] = 4328,
    },
    ...
    chapters = {
        ...
        },
        {
            ...
            quests = {
                ...
                { id = 262, name = "The Shadowy Figure", npc = "Sven Yorgen" },
                { id = 265, name = "The Shadowy Search Continues", npc = "Madame Eva" },
                { id = 266, name = "Inquire at the Inn", npc = "Clerk Daltry" },
                { id = 453, name = "Finding the Shadowy Figure", npc = "Tavernkeep Smitts" },
                { id = 268, name = "Return to Sven", npc = "Jitters" },
                { id = 323, name = "Proving Your Worth", npc = "Sven Yorgen" },
                { id = 269, name = "Seeking Wisdom", npc = "Sven Yorgen" },
                { id = 270, name = "The Doomed Fleet", npc = "Bishop Farthing" },
                { id = 321, name = "Lightforge Iron", npc = "Glorin Steelbrow" },
                { id = 324, altIds = { 526 }, name = "The Lost Ingots", npc = "Waterlogged Chest" },
                { id = 322, name = "Blessed Arm", npc = "Glorin Steelbrow" },
                { id = 325, name = "Armed and Ready", npc = "Grimand Elmore" },
                { id = 101, name = "The Totem of Infliction", npc = "Madame Eva" },
                { id = 55, name = "Morbent Fel", npc = "Sven Yorgen" },
            },
        },
        {
            ...
            quests = {
                ...
                { id = 231, name = "A Daughter's Love", npc = "Watcher Ladimore" },
            },
        },
        {
            ...
            quests = {
                ...
                { id = 68, name = "The Legend of Stalvan", displayName = "The Dusty Letter", npc = "Old Footlocker" },
                { id = 69, name = "The Legend of Stalvan", displayName = "Updated Registry", npc = "Clerk Daltry" },
                { id = 70, name = "The Legend of Stalvan", displayName = "Stormwind Canals", npc = "Innkeeper Farley" },
                { id = 72, name = "The Legend of Stalvan", displayName = "Goldshire", npc = "Caretaker Folsom" },
                { id = 74, name = "The Legend of Stalvan", displayName = "Marshal Haggard", npc = "Sealed Crate" },
                { id = 75, name = "The Legend of Stalvan", displayName = "The Torn Page", npc = "Marshal Haggard" },
                { id = 78, name = "The Legend of Stalvan", displayName = "Back to Darkshire", npc = "Marshal Haggard" },
                { id = 79, name = "The Legend of Stalvan", displayName = "The Manor", npc = "Tavernkeep Smitts" },
                { id = 80, name = "The Legend of Stalvan", displayName = "Mistmantle", npc = "Commander Althea Ebonlocke" },
                { id = 97, name = "The Legend of Stalvan", displayName = "The Ring", npc = "Clerk Daltry" },
