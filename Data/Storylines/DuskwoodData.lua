...
SM.DuskwoodData = {
    ...
    npcLocations = {
        ...
        ["Bishop Farthing"] = { mapID = 84, x = 0.5000, y = 0.4600, location = "Cathedral Square, Stormwind" },
        ["Glorin Steelbrow"] = { mapID = 56, x = 0.1058, y = 0.6059, location = "Menethil Harbor, Wetlands" },
        ["Grimand Elmore"] = { mapID = 84, x = 0.5960, y = 0.3400, location = "the Dwarven District, Stormwind" },
    ...
    chapters = {
        ...
        },
        {
            ...
            quests = {
                ...
                { id = 230, name = "Sven's Camp", npc = "Sven Yorgen" },
                ...
                { id = 324, altIds = { 526 }, name = "The Lost Ingots", npc = "Glorin Steelbrow" },
