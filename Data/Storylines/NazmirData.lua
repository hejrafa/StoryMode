    ...
    chapters = {
        ...
        -- CHAPTER 2: A Pact With Death
        {
            ...
            quests = {
                ...
                { id = 49278, name = "Spiritual Restoration",   npc = "Bwonsamdi", mapID = 863, x = 0.3660, y = 0.5380, location = "A Pact With Death, Nazmir" },
        ...
        -- CHAPTER 6: A Friend of the Frogs
        {
            ...
            quests = {
                ...
                { id = 47659, name = "Hunt the Hunter",         npc = "Krag'wa", mapID = 863, x = 0.6740, y = 0.4220, location = "A Friend of the Frogs, Nazmir" },
                { id = 47660, name = "Fallen Idols",            npc = "Krag'wa", mapID = 863, x = 0.6740, y = 0.4220, location = "A Friend of the Frogs, Nazmir" },
                { id = 52294, name = "Fallen Idols",            npc = "Krag'wa", optional = true, mapID = 863, x = 0.6740, y = 0.4220, location = "A Friend of the Frogs, Nazmir" },
                { id = 47623, name = "The Last Witch Doctor of Krag'wa", npc = "Krag'wa", mapID = 863, x = 0.6740, y = 0.4220, location = "A Friend of the Frogs, Nazmir" },
                { id = 47621, name = "A True Loa Feast",        npc = "Krag'wa", mapID = 863, x = 0.6740, y = 0.4220, location = "A Friend of the Frogs, Nazmir" },
                { id = 47622, name = "A Magical Glow",          npc = "Krag'wa", mapID = 863, x = 0.6740, y = 0.4220, location = "A Friend of the Frogs, Nazmir" },
                { id = 47540, name = "Totemic Restoration",     npc = "Krag'wa", mapID = 863, x = 0.6740, y = 0.4220, location = "A Friend of the Frogs, Nazmir" },
                { id = 47696, name = "Krag'wa the Terrible",   npc = "Krag'wa", mapID = 863, x = 0.6740, y = 0.4220, location = "A Friend of the Frogs, Nazmir" },
            },
        },
        ...
        -- CHAPTER 8: Bleeding the Blood Trolls
        {
            ...
            quests = {
                ...
                { id = 52073, name = "Petitioning Krag'wa",    npc = "Krag'wa", mapID = 863, x = 0.6740, y = 0.4220, location = "Bleeding the Blood Trolls, Nazmir" },
        ...
        -- CHAPTER 10: The Battle of Dazar'alor
        {
            ...
            quests = {
                { id = 54282, name = "Battle of Dazar'alor",  npc = "Bwonsamdi", mapID = 863, x = 0.3660, y = 0.5380, location = "The Battle of Dazar'alor, Nazmir" },
            },
        },
    },
}
