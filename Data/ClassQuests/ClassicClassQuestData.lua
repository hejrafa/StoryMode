    ...
    chapters = {
        {
            ...
            quests = {
                ...
                { id = 1652, name = "The Tome of Valor", npc = "Duthorian Rall", faction = "Alliance", mapID = 84, x = 0.3981, y = 0.2980, location = "Duthorian Rall, Cathedral Square, Stormwind" },
            },
        },
        {
            ...
            quests = {
                ...
                { id = 1655, name = "Bailor's Ore Shipment", npc = "Jordan Stilwell", faction = "Alliance", mapID = 27, x = 0.5249, y = 0.3692, location = "Jordan Stilwell, Dun Morogh" },
                { id = 1442, name = "Seeking the Kor Gem", npc = "Jordan Stilwell", faction = "Alliance", mapID = 27, x = 0.5249, y = 0.3692, location = "Jordan Stilwell, Dun Morogh" },
        ...
        },
        {
            ...
            quests = {
                ...
                { id = 7644, name = "Blessed Arcanite Barding", npc = "Lord Grayson Shadowbreaker", faction = "Alliance", mapID = 84, x = 0.3714, y = 0.3326, location = "Lord Grayson Shadowbreaker, Cathedral Square, Stormwind" },
    ...
    chapters = {
        ...
        },
        {
            ...
            quests = {
                ...
                { id = 100, name = "Call of Water", npc = "Islen Waterseer", faction = "Horde", mapID = 10, x = 0.6583, y = 0.4378, location = "Islen Waterseer, The Barrens" },
            },
        },
        {
            chapter = "Call of Air",
    ...
    chapters = {
        ...
        },
        {
            ...
            quests = {
                ...
                { id = 1714, name = "Essence of the Exile", npc = "Bath'rah the Windwatcher", mapID = 25, x = 0.8050, y = 0.6692, location = "Bath'rah the Windwatcher, Alterac Mountains" },
