...
SM.JadeForestData = {
    ...
    chapters = {
        ...
        -- CHAPTER 5: What We Have Wrought
        {
            ...
            note = "This is the first time Pandaria shows both factions the consequences of their war. The Sha are not monsters — they are emotions made manifest. Everything the sha does in this zone came from the player.",
            quests = {
