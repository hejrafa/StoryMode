...
SM.RevendrethData = {
    ...
    npcLocations = {
        ...
        ["Rendle"]                 = { mapID = 1525, x = 0.6130, y = 0.6350 },
        ...
        ["The Accuser"]            = { mapID = 1525, x = 0.5140, y = 0.5980 },
        ["The Fearstalker"]        = { mapID = 1525, x = 0.5070, y = 0.7380 },
        ["Houndmaster Loksey"]     = { mapID = 1525, x = 0.5120, y = 0.7430 },
        ["Flockmaster Sergio"]     = { mapID = 1525, x = 0.5120, y = 0.7430 },
        ["Watchmaster Boromod"]    = { mapID = 1525, x = 0.5140, y = 0.5980 },
    ...
    chapters = {
        {
            ...
            quests = {
                ...
                { id = 56829, name = "Bottom Feeders",             npc = "Lord Chamberlain" },
                { id = 57381, name = "The Greatest Duelist",       npc = "Nadjia the Mistblade" },
                { id = 56942, name = "On The Road Again",          npc = "Lord Chamberlain" },
...

        {
            ...
            quests = {
                ...
                { id = 58654, name = "A Plea to the Harvesters",   npc = "Lord Chamberlain" },
                { id = 57178, name = "The Master Awaits",          npc = "Myskia" },
...

        {
            ...
            quests = {
                ...
                { id = 58931, name = "Inquisitor Stelia's Sinstone", npc = "Echelon" },
...

        {
            ...
            quests = {
                ...
                { id = 58941, name = "Alpha Bat",                  npc = "Houndmaster Loksey" },
                ...
                { id = 57189, name = "Breaking the Hopebreakers",  npc = "Watchmaster Boromod" },
                { id = 57190, name = "They Won't Know What Hit Them", npc = "Watchmaster Boromod" },
                { id = 59209, name = "Rebel Reinforcements",       npc = "The Accuser" },
...

        {
            ...
            quests = {
                ...
                { id = 57405, name = "Chasing Madness",            npc = "Theotar" },
                ...
                { id = 57724, name = "Securing Sinfall",           npc = "Theotar" },
            },
        },

        {
            ...
            quests = {
                ...
                { id = 57689, name = "Prince Renathal",            npc = "Theotar" },
                ...
                { id = 57694, name = "Refuge of Revendreth",       npc = "General Draven" },
            },
        },
