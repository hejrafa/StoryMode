...
SM.FrozenThroneData = {
    ...
    startQuest = { id = 13149, name = "Dispelling Illusions", npc = "Chromie", location = "Culling of Stratholme, Dragonblight" },
    startMapID = 115, -- Dragonblight
    startX = 0.6000,
    startY = 0.5000,

    npcLocations = {
        ["Chromie"]                    = { mapID = 115, x = 0.6000, y = 0.5000 },
        ...
        ["Baron Sliver"]               = { mapID = 118, x = 0.4300, y = 0.2400 },
        ["Vereth the Cunning"]         = { mapID = 118, x = 0.5800, y = 0.4600 },
        ...
        ["Gorkun Ironskull"]           = { mapID = 125, x = 0.5600, y = 0.5700 },
        ["Jaina Proudmoore"]           = { mapID = 604, x = 0.5100, y = 0.5400 },
        ["Sylvanas Windrunner"]        = { mapID = 604, x = 0.5100, y = 0.5400 },
    },
    ...
    chapters = {
        ...
        {
            chapter = "A City Must Burn",
            summary = "Travel through time to Stratholme and preserve the moment that pushes Prince Arthas over the edge.",
        ...
        },
        {
            ...
            summary = "Break the Scourge hold over the Shadow Vault and establish a forward base for the war in Icecrown.",
        ...
        {
            chapter = "Malykriss and Saronite",
            summary = "Scout Malykriss and tear into the Scourge war machine feeding Icecrown's defenses.",
            recap = "At Malykriss, you uncover the scale of Arthas' war industry: fleshworks, torture pits, and endless saronite labor. Every raid weakens the defenses standing between the armies of Azeroth and the Frozen Throne.",
            quests = {
                { id = 13145, name = "The Vile Hold", npc = "Vereth the Cunning" },
                { id = 13300, name = "Slaves to Saronite", npc = "Thassarian / Koltira Deathweaver" },
            },
        },
        {
            chapter = "Icecrown Vanguard",
        ...
        {
            chapter = "The Unthinkable",
            summary = "Confront the horrors beneath Icecrown and uncover the final shape of the Scourge threat.",
            recap = "The campaign descends into the most grotesque heart of the Scourge. What you witness in these halls leaves no room for compromise: Arthas must be ended, no matter the cost.",
            quests = {
        ...
        {
            chapter = "Tirion's Gambit",
            summary = "Join Tirion Fordring's high-risk strike to destabilize Scourge command at the citadel's doorstep.",
            recap = "With the Argent Crusade committed, Tirion launches a direct gambit against the Lich King's command structure. The offensive costs dearly, but it forces the final phase of the war into motion.",
            quests = {
        ...
        },
        {
            ...
            summary = "Take the war to the Valley of Lost Hope and turn Scourge engines against their own lines.",
            recap = "With pressure building near Icecrown Citadel, you wage mechanized war in the valley, raising undead shock troops and smashing the Scourge footholds that protect Arthas' inner approaches.",
            quests = {
                { id = 13305, name = "Do Your Worst", npc = "Matthias Lehner" },
                { id = 13395, name = "Army of the Damned", npc = "Matthias Lehner" },
                { id = 13348, name = "Futility", npc = "Thassarian / Koltira Deathweaver" },
            },
        },
        {
        ...
        {
            chapter = "Frozen Halls: Breach the Citadel",
        ...
        {
            chapter = "Frozen Halls: The Pit of Saron",
        ...
        {
            chapter = "The Sword and the Memory",
        ...
        {
            chapter = "Wrath of the Lich King",
