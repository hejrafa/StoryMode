...
SM.MageCampaignData = {
    ...
    npcLocations = {
        ...
        ["The Great Akazamzarak"]       = { mapID = 627, x = 0.4660, y = 0.4620 },
        ["Archmage Kalec"]              = { mapID = 734, x = 0.5000, y = 0.4900 },
        ["Archmage Modera"]             = { mapID = 734, x = 0.5100, y = 0.5000 },
        ["Archmage Melis"]              = { mapID = 734, x = 0.5300, y = 0.5200 },
        ["Archmage Omniara"]            = { mapID = 734, x = 0.5100, y = 0.5300 },
        ["Ravandwyr"]                   = { mapID = 627, x = 0.4800, y = 0.4800 },
        ["Esara Verrinde"]              = { mapID = 627, x = 0.4700, y = 0.4900 },
        ["Archmage Khadgar"]            = { mapID = 627, x = 0.2860, y = 0.4870 },
        ["Archmage Vargoth"]            = { mapID = 734, x = 0.5200, y = 0.5000 },
    ...
    chapters = {
        ...
        -- CHAPTER 2: Establishing the Order Hall
        {
            ...
            quests = {
                ...
                { id = 42126, name = "Archmage Omniara",            npc = "Archmage Kalec" },
                { id = 42127, name = "Building Our Troops",         npc = "Archmage Omniara" },
                { id = 42687, name = "Troops in the Field",         npc = "Archmage Omniara" },
                { id = 42433, name = "Ancient Magic",               npc = "Meryl Felstorm" },
            },
        },
        ...
        -- CHAPTER 3: The Empyrean Society
        {
            ...
            quests = {
                { id = 42418, name = "An Unexpected Visitor",       npc = "Meryl Felstorm" },
        ...
        -- CHAPTER 4: The Search for Vargoth
        {
            ...
            quests = {
                { id = 42416, name = "The Council is in Session",   npc = "Meryl Felstorm" },
                { id = 42423, name = "Archmage Vargoth's Retreat",  npc = "Archmage Khadgar" },
                { id = 42424, name = "Following In His Footsteps",  npc = "Archmage Khadgar" },
                { id = 42451, name = "Kalec's Plan",                npc = "Archmage Kalec" },
                { id = 42508, name = "Not A Toothless Dragon",      npc = "Archmage Kalec" },
                { id = 42521, name = "The Enemy of My Enemy...",    npc = "Archmage Kalec" },
                { id = 42493, name = "Impending Dooooooom!",        npc = "Archmage Kalec" },
                { id = 42520, name = "A Terrible Loss",             npc = "Archmage Khadgar" },
