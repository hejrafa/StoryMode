...
- Replaced the Story Mode intro/card artwork with a shared banner treatment and removed the extra card text/icon overlay
...
### Maintenance
- Added GitHub Actions packaging for tag-driven GitHub, CurseForge, and Wago releases, plus `.pkgmeta` release-zip rules
