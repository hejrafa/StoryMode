...
SM.HunterCampaignData = {
    ...
    npcLocations = {
        ...
        ["Hudson Crawford"]             = { mapID = 634, x = 0.6000, y = 0.5100 },
        ["Beastmaster Hilaire"]         = { mapID = 634, x = 0.6000, y = 0.5100 },
        ["Rexxar"]                      = { mapID = 650, x = 0.4400, y = 0.3700 },
        ["Halduron Brightwing"]         = { mapID = 739, x = 0.4300, y = 0.4700 },
        ["Shandris Feathermoon"]        = { mapID = 646, x = 0.4500, y = 0.6400 },
    ...
    npcDisplayIDs = {
        ["Snowfeather"]                 = 65775,
        ["Emmarel Shadewarden"]         = 65116,
        ["Tactician Tinderfell"]        = 65117,
        ["Altar Keeper Biehn"]          = 65118,
        ["Hudson Crawford"]             = 65119,
        ["Beastmaster Hilaire"]         = 65120,
        ["Rexxar"]                      = 67710,
        ["Halduron Brightwing"]         = 29524,
        ["Shandris Feathermoon"]        = 66289,
        ["Archmage Khadgar"]            = 65402,
        ["Kira Iresoul"]                = 64712,
        ["Hemet Nesingwary"]            = 24454,
        ["Nighthuntress Syrenne"]       = 69440,
        ["Maiev Shadowsong"]            = 67028,
        ["Nimi Brightcastle"]           = 22258,
    },
    ...
    chapters = {
        ...
        -- CHAPTER 2: Establishing the Order
        {
            ...
            quests = {
                ...
                { id = 42409, name = "Champion: Loren Stormhoof",   npc = "Altar Keeper Biehn" },
        ...
        -- CHAPTER 4: Watchers in the Wild II
        {
            ...
            quests = {
                ...
                { id = 42398, name = "Awakening the Senses",        npc = "Emmarel Shadewarden" },
                { id = 42412, name = "Champion: Huntsman Blake",    npc = "Emmarel Shadewarden" },
                { id = 42400, name = "Missing Mages",               npc = "Emmarel Shadewarden" },
                { id = 42401, name = "The Scent of Magic",          npc = "Emmarel Shadewarden" },
                { id = 42404, name = "Assisting the Archmage",      npc = "Archmage Khadgar" },
                { id = 42689, name = "Knowing Our Enemy",           npc = "Archmage Khadgar" },
